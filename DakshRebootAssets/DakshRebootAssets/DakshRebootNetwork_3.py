"""
Final API for Daksh Reboot ( api() is Configured to match with Flask Appv2.py )
...
#=====DRAW BBOX ON HIGH ACTIVATION AREA======#
    ...
    return outputClassNames,outputCoords,outputconfidence #Returning the dict of output classnames to be rendered at final.html
